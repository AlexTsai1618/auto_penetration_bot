...
class report_app:
    def __init__(self,name):
        self.name = name
        self.paths()
    def report(self,vuln_count,share_data,computer_os,ips,account):
    ...
    def data_count(self,datas):
        ...
        print(ips)
        print(account)
        self.report(vuln_count,share_data,computer_os,ips,account)
